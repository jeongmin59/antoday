...
import styles from "./MyInvestmentStockComponent.module.css";
...
const MyInvestmentStockComponent: React.FC<StockInfoComponentProps> = ({
  companyInfo,
}) => {
...
export default MyInvestmentStockComponent;
