...
def get_market_info(KOSPI_symbol, KOSDAQ_symbol):
    # KOSPI(STK - KS11)
    KOSPI_base_date, KOSPI_close, kKOSPI_percentage_change, KOSPI_change = get_calculate_KSQSTK(KOSPI_symbol)
    # KOSDAQ(KSQ - KQ11)
    KOSDAQ_base_date, KOSDAQ_close, KOSDAQ_percentage_change, KOSDAQ_change = get_calculate_KSQSTK(KOSDAQ_symbol)
...
def get_calculate_KSQSTK(symbol):
    ...
    return base_date, close_price_formatted, percentage_change_formatted, price_change_formatted